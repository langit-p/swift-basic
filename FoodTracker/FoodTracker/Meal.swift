...
class Meal: NSObject, NSCoding {
    ...
    static let ArchieveURL = DocumentsDirectory.appendingPathComponent("meals")
    ...
    init?(name: String, photo: UIImage?, rating: Int, comment: String) {
        //Initiliazation should be fail if there is no name or if the rating is negative.
